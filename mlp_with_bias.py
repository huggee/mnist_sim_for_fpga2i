        ...
        #　順伝播計算
            for var1 in range(0,self.layers-1):
                ...
                # HIDDEN to OUTPUT
                    ...
                    self.hid[var1-1] = np.hstack([1, self.hid[var1-1] ])
        ...
        # 逆伝播計算 + 重み更新
            for var1 in range(0,self.layers-1):
                ...
                if var1 == 0:
                    ...
                    # PHI逆伝播
                    for val2 in range(0,self.hid[inv_lay-1].size-1):
                        #print(val2)
                        ph_[val2] = bit_16(dif(self.hid[inv_lay-1][val2+1],act[inv_lay-1]) * multiply_lea(ph , w[val2+1]))
                ...
                # HIDDEN to HIDDEN
                    ...
                    # PHI算出
                    for val2 in range(0,self.hid[inv_lay-1].size-1):
                        ph[val2] = bit_16(dif(self.hid[inv_lay-1][val2+1],act[inv_lay-1]) * multiply_lea(ph2 , w[val2+1]))
